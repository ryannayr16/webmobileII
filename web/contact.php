...
<?php
// Ambil data kontak_redaksi dari database
$sql = "SELECT * FROM kontak_redaksi LIMIT 1";
$result = $mysqli->query($sql);

if ($result->num_rows === 0) {
    die("Data kontak redaksi tidak ditemukan.");
}
                                ...
                                <div class="col-sm-12">
                                    <table border="0" width="100%">
                                        <tr>
                                            <th>Telp</th>
                                            <td>:</td>
                                            <td><?php echo htmlspecialchars($kontak['telp'], ENT_QUOTES, 'UTF-8'); ?></td>
                                        </tr>
                                        <tr>
                                            <th>No. Handphone</th>
                                            <td>:</td>
                                            <td><?php echo htmlspecialchars($kontak['no_handphone'], ENT_QUOTES, 'UTF-8'); ?></td>
                                        </tr>
                                        <tr>
                                            <th>E-mail</th>
                                            <td>:</td>
                                            <td><?php echo htmlspecialchars($kontak['email'], ENT_QUOTES, 'UTF-8'); ?></td>
                                        </tr>
                                        <tr>
                                            <th>Alamat Redaksi</th>
                                            <td>:</td>
                                            <td><?php echo htmlspecialchars($kontak['alamat'], ENT_QUOTES, 'UTF-8'); ?></td>
                                        </tr>
                                    </table>
                                </div>
                                <div class="clear"></div>
