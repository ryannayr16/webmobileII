...
<div class="container-fluid footer">
	<div class="row footer-upper">
		<div class="container">
			...
			<div class="col-md-4">
				<h3 class="page-header">Teknik</h3>
				<ul class="news-list">
	...
	<div class="row footer-bottom">
		<div class="col-md-12">
			<span class="copy">Copyright &copy; <?php echo date('Y');?> AFT DEO Sorong</span>
		</div>
	</div>
</div>
